...
const Footer = () => {
  ...
  >
    <img className="footer-img" src="/img/20.png" alt="Instagram" />
  </a>
  ...
  <a
    ...
    rel="noopener noreferrer"
  >
    <img className="footer-img" src="/img/21.png" alt="Facebook" />
  </a>
  ...
  <a
    ...
    rel="noopener noreferrer"
  >
    <img className="footer-img" src="/img/22.png" alt="X" />
  </a>
